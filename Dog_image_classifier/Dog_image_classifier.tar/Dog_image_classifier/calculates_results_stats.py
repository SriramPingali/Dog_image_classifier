...
def calculates_results_stats(results_dic):
    ...
    for dogfile,labels in results_dic.items():
        ...
        if labels[4]==1 and labels[3]==1:
            results_stats_dic['n_correct_dogs']+=1
        if labels[4]==0 and labels[3]==0:
             results_stats_dic['n_correct_notdogs']+=1
        if labels[2]==1 and labels[3]==1:
            results_stats_dic['n_correct_breed']+=1
    results_stats_dic['pct_match']=results_stats_dic['n_match']/results_stats_dic['n_images']*100 
    results_stats_dic['pct_correct_dogs']=results_stats_dic['n_correct_dogs']/results_stats_dic['n_dog_img']*100   
    results_stats_dic['pct_correct_breed']=results_stats_dic['n_correct_breed']/results_stats_dic['n_dogs_img']*100
    results_stats_dic['pct_correct_notdogs']=results_stats_dic['n_correct_notdogs']/results_stats_dic['n_notdog_img']*100
